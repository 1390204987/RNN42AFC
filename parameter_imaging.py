...
mean_value_flat = mean_matrix.flatten()
...
def plot_box(plot_data,x_name,show_para,corr,p):
    ...
    # filtered_data = plot_data[plot_data[show_para] ]
...
plt.show()
plt.savefig("./lunwenfigure/Z_deltaabs.svg")

plt.figure()
# plt.scatter( valid_data_joverz['J_over_Z'],valid_data_joverz[show_para])
plot_box(valid_data_joverz,'J_over_Z',show_para,corr_joverz,p_joverz)
plt.show()
plt.savefig("./lunwenfigure/JoverZ_deltaabs.svg")
