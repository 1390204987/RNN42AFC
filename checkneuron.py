...
from tools_divergence import plot_divergence, plot_conditioned_divergence
...
def neuralactivity_color_dm(model_dir,**kwargs):
    ...
    plot_divergence(sacdir_list,neural_activity[:,:,:hidden1_size],times_relate,rule_name,rule=rule,figname=figname,figname_append = kwargs['figname_append'],para=h1para)
    if not hp.get("hidden_size2") is None:
        plot_divergence(sacdir_list,neural_activity[:,:,hidden1_size:],times_relate,rule_name,rule=rule,figname=figname,figname_append = kwargs['figname_append'],para=h2para)
    ...
    # plot_divergence(heading0_choice,heading0_h1_activity,times_relate,rule_name,rule=rule,figname=figname,figname_append = kwargs['figname_append'],para=h1para)
    if not hp.get("hidden_size2") is None:
        ...
        # plot_divergence(heading0_choice,heading0_h2_activity,times_relate,rule_name,rule=rule,figname=figname,figname_append = kwargs['figname_append'],para=h2para)
