# -*- coding: utf-8 -*-
"""
Created on Sun Nov  6 15:36:51 2022
...
class EIRecLinear(nn.Module):
    ...
    def __init__(self,device,hidden_size1,hidden_size2,feedback_stren,bias=True):
        super().__init__()
...
class ReadinLinear(nn.Module):
    ...
    def __init__(self,device,in_features,hidden_size1,hidden_size2,bias=True):
        super().__init__()
...
class EIRNN(nn.Module):
    ...
    """
    def __init__(self, device,input_size, hidden_size1, hidden_size2,fbackstren, dt=None, sigma_rec=0.1, **kwargs):
        super().__init__()
        ...
        if dt is None:
            ...
            self.input2h = ReadinLinear(device,input_size,hidden_size1,hidden_size2)
            self.h2h = EIRecLinear(device,hidden_size1,hidden_size2,feedback_stren=fbackstren)
    ...
    def recurrence(self, inputs,hidden):
        ...
        state = state+self._sigma_rec*torch.randn_like(state)
        output = F.relu(state)
        return state, output  
...
class Net(nn.Module):
    ...
    def __init__(self,hp,**kwargs):
        ...
        self.rnn = EIRNN(self.device,input_size, hidden_size1, hidden_size2,fbackstren,**kwargs)            
